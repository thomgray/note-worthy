...
//    iterator.readMdHeader("## this is a header", 0) shouldBe Some(MdHeader("this is a header", 2, @@(0,1)))
//  }
//
//  it should "not find a header where ther isn't one" in {
//    iterator.readMdHeader("this is a line", 0) shouldBe None
//  }
//
...
//      """.stripMargin.split("\n")
//
//    iterator.indexOfNextHeader(0, lines, 0) shouldBe Some((2, MdHeader("three", 1, @@(2,3))))
//  }
//
...
//      """.stripMargin.split("\n")
//
//    iterator.indexOfNextHeader(0, str, 2) shouldBe Some((2, MdHeader("three", 2, @@(2,3))))
//  }
//
...
//      """.stripMargin.split("\n")
//
//    iterator.indexOfNextHeader(0, str, 5) shouldBe Some((2, MdHeader("three", 1, @@(2,3))))
//  }
//
...
//    iterator.rageOfNextHeaderBlock(0, lines) shouldBe Some((1, 4, MdHeader("hello", 1, @@(1,2))))
//  }
//
...
//        |this is content""".stripMargin.split("\n")
//
//    iterator.rageOfNextHeaderBlock(0, lines) shouldBe Some((1, 7, MdHeader("hello", 1, @@(1,2))))
//  }
//
...
//
//    range1 shouldBe Some((0, 4, MdHeader("header 1", 1, @@(0,1))))
//    range2 shouldBe Some(4, 7, MdHeader("header 2", 1, @@(4,5)))
//  }
//
